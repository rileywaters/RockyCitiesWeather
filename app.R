              ...
              fluidRow(
                column(6, offset = 3,
                 p(style = "font-family: 'Source Sans Pro'; font-size: 18px",
                   "This is an application for interacting with historical temperature data from Vancouver BC, Kelowna BC, and Calgary AB. 
                 ...
                 tags$ul(style = "font-family: 'Source Sans Pro'; font-size: 16px",
                   ...
                   tags$li("Compare temperature visualizations"), 
                   tags$li("Run simulations and tests on the data")
                 ),
                 br(),
                 tags$i(style = "font-family: 'Source Sans Pro'; font-size: 16px",
                        "App created by Riley Waters for STAT406 Environmentrics.",
                        br(),
                        "Data cleaned and compiled by Riley Waters. Last updated on November 29, 2017."
                 )
                )
              ),
              br(),br(),
...
server <- function(input, output, session) {
  ...
  #Multiple simulation ANOVA results
